...
for ieta in eta :
    ...
    for iwp in wp :
        ...
        filepath = os.path.join(os.environ['CMSSW_BASE'],'src/TauFW/Fitter/MuTauFR/input', "MuTauFR_m_vis_eta%s_mt-UL2016_postVFP.inputs.root")%(ieta)
        ...
        datacardPath = 'input/UL2016_postVFP/MuTauFR/%s_eta%s.txt'%(iwp,ieta)
        shapePath = 'input/UL2016_postVFP/MuTauFR/common/%s_eta%s.root'%(iwp,ieta)
