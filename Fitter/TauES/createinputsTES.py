...
#      sampleset = getsampleset(channel,era,fname=sname,join=join,split=None,table=False)
      ...
      if channel=='mumu':
        ...
        varprocs = OrderedDict([ 
          ...
          ('TES0.970', ['ZTT','VV','ST','TTT']),
          ('TES0.972', ['ZTT','VV','ST','TTT']),
          ('TES0.974', ['ZTT','VV','ST','TTT']),
          ('TES0.976', ['ZTT','VV','ST','TTT']),
          ('TES0.978', ['ZTT','VV','ST','TTT']),
          ('TES0.980', ['ZTT','VV','ST','TTT']),
          ('TES0.982', ['ZTT','VV','ST','TTT']),
          ('TES0.984', ['ZTT','VV','ST','TTT']),
          ('TES0.986', ['ZTT','VV','ST','TTT']),
          ('TES0.988', ['ZTT','VV','ST','TTT']),
          ('TES0.990', ['ZTT','VV','ST','TTT']),
          ('TES0.992', ['ZTT','VV','ST','TTT']),
          ('TES0.994', ['ZTT','VV','ST','TTT']),
          ('TES0.996', ['ZTT','VV','ST','TTT']),
          ('TES0.998', ['ZTT','VV','ST','TTT']),
          ('TES1.000', ['ZTT','VV','ST','TTT']),
          ('TES1.002', ['ZTT','VV','ST','TTT']),
          ('TES1.004', ['ZTT','VV','ST','TTT']),
          ('TES1.006', ['ZTT','VV','ST','TTT']),
          ('TES1.008', ['ZTT','VV','ST','TTT']),
          ('TES1.010', ['ZTT','VV','ST','TTT']),
          ('TES1.012', ['ZTT','VV','ST','TTT']),
          ('TES1.014', ['ZTT','VV','ST','TTT']),
          ('TES1.016', ['ZTT','VV','ST','TTT']),
          ('TES1.018', ['ZTT','VV','ST','TTT']),
          ('TES1.020', ['ZTT','VV','ST','TTT']),
          ('TES1.022', ['ZTT','VV','ST','TTT']),
          ('TES1.024', ['ZTT','VV','ST','TTT']),
          ('TES1.026', ['ZTT','VV','ST','TTT']),
          ('TES1.028', ['ZTT','VV','ST','TTT']),
          ('TES1.030', ['ZTT','VV','ST','TTT']),
        ])
