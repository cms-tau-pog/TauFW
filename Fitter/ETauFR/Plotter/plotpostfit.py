...
parser.add_argument('-y', '--era',      dest='eras', nargs='*', choices=['2016','2017','2018','UL2017','UL2018','UL2016_preVFP','UL2016_postVFP', '2022_postEE', '2022_preEE', '2024'], default=['UL2017'], action='store',
                                        help="set era" )
