...
def plot(sampleset,channel,parallel=True,tag="",outdir="plots",era="",pdf=False):
  ...
  variables = [
    ...
    Var('rawDeepTau2017v2p1VSjet_2', "rawDeepTau2017v2p1VSjet", 30, 0.70, 1, fname="$VAR_zoom",ncols=2,pos='L;y=0.85'),
    Var('rawDeepTau2017v2p1VSe_2',   "rawDeepTau2017v2p1VSe",   20, 0.80, 1, fname="$VAR_zoom",ncols=2,logy=True,pos='L;y=0.85'),
