...
def plot(sampleset,setup,parallel=True,tag="",extratext="",outdir="plots",era="",
  ...
  if 'tau' in channel: # mutau, etau, tautau
    ...
    variables += [
      ...
      Var('rawDeepTau2018v2p5VSjet_2', "rawDeepTau2018v2p5VSjet", 100, 0.0, 1, ncols=2,pos='L;y=0.85',logy=True,ymargin=1.5,cbins={"VSjet_2>":(60,0.4,1)}),
      Var('rawDeepTau2018v2p5VSjet_2', "rawDeepTau2018v2p5VSjet", 20, 0.80, 1, fname="$VAR_zoom",ncols=2,pos='L;y=0.85'),
      Var('rawDeepTau2018v2p5VSe_2',   "rawDeepTau2018v2p5VSe",   30, 0.70, 1, fname="$VAR_zoom",ncols=2,logy=True,logyrange=4,pos='L;y=0.85'),
      Var('rawDeepTau2018v2p5VSmu_2',  "rawDeepTau2018v2p5VSmu",  20, 0.80, 1, fname="$VAR_zoom",ncols=2,logy=True,logyrange=5,pos='L;y=0.85'),
    ]
