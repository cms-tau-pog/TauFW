...
def getsampleset(channel,era,**kwargs):
  ...
  if '2022_preEE' in era or '2022_postEE' in era or '2023'in era or '2024' in era or '2025' in era: # so far same samples and cross sections are used for preEE and postEE, if event numbers are set elsewhere then we don't need to add seperate numbers for both eras
    ...
    if '2024' in era:
      expsamples = [ # table of MC samples to be converted to Sample objects
        ...
        # ( 'DY', "DYto2Tau_Bin-MLL-10to50",       "Drell-Yan 10-50",        6744, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below 
        # ( 'DY', "DYto2Mu_Bin-MLL-10to50",       "Drell-Yan 10-50",        6744, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below
        ( 'DY', "DYto2E_Bin-MLL-10to50",       "Drell-Yan 10-50",        6744, {'extraweight': dyweight}),
        # ( 'DY', "DYto2Tau_Bin-MLL-50to120",       "Drell-Yan 50-120",        2219*kfactor_dy_powheg, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below 
        # ( 'DY', "DYto2Mu_Bin-MLL-50to120",       "Drell-Yan 50-120",        2219*kfactor_dy_powheg, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below
        ( 'DY', "DYto2E_Bin-MLL-50to120",       "Drell-Yan 50-120",        2219*kfactor_dy_powheg, {'extraweight': dyweight}),
        # ( 'DY', "DYto2Tau_Bin-MLL-120to200",       "Drell-Yan 120-200",        21.65*kfactor_dy_powheg, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below 
        # ( 'DY', "DYto2Mu_Bin-MLL-120to200",       "Drell-Yan 120-200",        21.65*kfactor_dy_powheg, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below
        ( 'DY', "DYto2E_Bin-MLL-120to200",       "Drell-Yan 120-200",        21.65*kfactor_dy_powheg, {'extraweight': dyweight}), 
        # ( 'DY', "DYto2Tau_Bin-MLL-200to400",       "Drell-Yan 200-400",        3.058*kfactor_dy_powheg, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below 
        # ( 'DY', "DYto2Mu_Bin-MLL-200to400",       "Drell-Yan 200-400",        3.058*kfactor_dy_powheg, {'extraweight': dyweight}), # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below
        ( 'DY', "DYto2E_Bin-MLL-200to400",       "Drell-Yan 200-400",        3.058*kfactor_dy_powheg, {'extraweight': dyweight}),  # LO times kfactor, commenting this one out as it is the same as the one below but in principle it should be possible to conbine this sample with the inclusive one below
        # ( 'DY', "DYto2E-2Jets_Bin-MLL-50",       "Drell-Yan 2 Jets",        2094.2, {'extraweight': dyweight}),
        # ( 'DY', "DYto2Mu-2Jets_Bin-MLL-50",       "Drell-Yan 2 Jets",        2094.2, {'extraweight': dyweight}),
        # ( 'DY', "DYto2Tau-2Jets_Bin-MLL-50",       "Drell-Yan 2 Jets",        2094.2, {'extraweight': dyweight}),
  ...
  if '2024' in era or '2025' in era:
      sampleset.stitch("DYto2*_Bin-MLL*", incl='DYto2*-4Jets_MLL-50', name="DY", cme=cme)
  else:
