...
f = open("../PicoProducer/samples/nanoaod_sumw_2022_preEE.json")
  ...
  if '2022_preEE' in era or '2022_postEE' in era or '2023'in era or '2024' in era: # so far same samples and cross sections are used for preEE and postEE, if event numbers are set elsewhere then we don't need to add seperate numbers for both eras
    ...
    if '2022_preEE' in era:
      expsamples = [ # table of MC samples to be converted to Sample objects
        ...
        ( 'DY', "DYto2L-4Jets_MLL-50_1J",      "Drell-Yan 1J 50",      978.3*kfactor_dy, {'extraweight': dyweight, "nevts":nevts_json["DYto2L-4Jets_MLL-50_1J"]} ), # LO times kfactor currently not available
        ( 'DY', "DYto2L-4Jets_MLL-50_2J",      "Drell-Yan 2J 50",      315.1*kfactor_dy, {'extraweight': dyweight, "nevts":nevts_json["DYto2L-4Jets_MLL-50_2J"]} ), # LO times kfactor
        ( 'DY', "DYto2L-4Jets_MLL-50_3J",      "Drell-Yan 3J 50",      93.7*kfactor_dy, {'extraweight': dyweight, "nevts":nevts_json["DYto2L-4Jets_MLL-50_3J"]} ), # LO times kfactor
        ( 'DY', "DYto2L-4Jets_MLL-50_4J",      "Drell-Yan 4J 50",      45.4*kfactor_dy, {'extraweight': dyweight, "nevts":nevts_json["DYto2L-4Jets_MLL-50_4J"]} ), # LO times kfactor
        ( 'WJ', "WJetsToLNu-4Jets",            "W + jets",           55300.*kfactor_wj, {"nevts":nevts_json["WJetsToLNu-4Jets"]} ), # LO times kfactor
        ( 'WJ', "WJetsToLNu-4Jets_1J",           "W + 1J",              9128.*kfactor_wj, {"nevts":nevts_json["WJetsToLNu-4Jets_1J"]}), # LO times kfactor
        ( 'WJ', "WJetsToLNu-4Jets_2J",           "W + 2J",              2922.*kfactor_wj, {"nevts":nevts_json["WJetsToLNu-4Jets_2J"]}  ), # LO times kfactor
        ( 'WJ', "WJetsToLNu-4Jets_3J",           "W + 3J",               861.3*kfactor_wj, {"nevts":nevts_json["WJetsToLNu-4Jets_3J"]} ), # LO times kfactor
        ( 'WJ', "WJetsToLNu-4Jets_4J",           "W + 4J",               415.4*kfactor_wj, {"nevts":nevts_json["WJetsToLNu-4Jets_4J"]}), # LO times kfactor
        ...
        ( 'ST', "TBbarQ_t-channel",      "ST t-channel t",       123.8, {"nevts":nevts_json["TBbarQ_t-channel"]} ), # NLO
        ( 'ST', "TbarBQ_t-channel",      "ST t-channel at",      75.47, {"nevts":nevts_json["TbarBQ_t-channel"]} ), # NLO
        ( 'ST', "TWminustoLNu2Q",             "ST tW semileptonic",         15.8, {"nevts":nevts_json["TWminustoLNu2Q"]} ), # NLO (36.0) times LNu2Q BR
        ( 'ST', "TWminusto2L2Nu",             "ST tW 2l2#nu",               3.8, {"nevts":nevts_json["TWminusto2L2Nu"]} ), # NLO (36.0) times 2L2Nu BR
        ( 'ST', "TbarWplustoLNu2Q",         "ST atW semileptonic",          15.9, {"nevts":nevts_json["TbarWplustoLNu2Q"]} ), # NLO (36.1) times LNu2Q BR
        ( 'ST', "TbarWplusto2L2Nu",         "ST atW 2l2#nu",                3.8, {"nevts":nevts_json["TbarWplusto2L2Nu"]} ), # NLO (36.1) times 2L2Nu BR
      ]
