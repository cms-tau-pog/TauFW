...
for ieta in eta :
    ...
    for iwp in wp :
        ...
        cb.cp().process(mc_backgrounds).AddSyst(cb,'lumi_2018', 'lnN', ch.SystMap()(1.026))
        ...
        filepath = os.path.join(os.environ['CMSSW_BASE'],'src/TauFW/Fitter/MuTauFR/input', "MuTauFR_m_vis_eta%s_mt-2018.inputs.root")%(ieta)
        ...
        datacardPath = 'input/2018/MuTauFR/%s_eta%s.txt'%(iwp,ieta)
        shapePath = 'input/2018/MuTauFR/common/%s_eta%s.root'%(iwp,ieta)
