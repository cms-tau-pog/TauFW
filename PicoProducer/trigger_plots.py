...
create_root_plot(eff_1_eta, "Efficiency 1: Single Muon Trigger", "#tau #eta", "HLT_IsoMu24_eta2p1 (muon only)", eff_1_eta_plot_path)
create_root_plot(eff_1_pt, "Efficiency 1: Single Muon Trigger", "#tau p_{T} (GeV)", "HLT_IsoMu24_eta2p1 (muon only)", eff_1_pt_plot_path)
create_root_plot(eff_2_eta, "Efficiency 2: Mu+Tau Trigger", "#tau #eta", "HLT_MuTau (Mu+Tau)", eff_2_eta_plot_path)
create_root_plot(eff_2_pt, "Efficiency 2: Mu+Tau Trigger", "#tau p_{T} (GeV)", "HLT_MuTau (Mu+Tau)", eff_2_pt_plot_path)
