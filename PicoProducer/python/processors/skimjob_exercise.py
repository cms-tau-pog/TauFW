...
# PRESELECTION
preselection = "HLT_IsoMu27 && Muon_pt > 28 && Tau_pt > 18 && Muon_mediumId == 1 && Muon_pfRelIso04_all < 0.5 && Tau_idDeepTau2017v2p1VSmu >= 1 && Tau_idDeepTau2017v2p1VSe >= 1 && Tau_idDeepTau2017v2p1VSjet >= 1"
...
# RUN
p = PostProcessor(outdir,infiles,cut=preselection,branchsel=None,outputbranchsel=branchsel,noOut=False,
...
# DONE
print ">>> skimjob_exercise.py done after %.1f seconds"%(time.time()-time0)
