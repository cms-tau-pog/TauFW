...
class LHEDumper(Module):
  ...
  def analyze(self,event):
    ...
    print(" \033[4m%7s %7s %7s %7s %7s %7s %7s %7s %7s %8s %9s %10s  \033[0m"%(
      "index","pdgId","moth","mothId","dR","mass","pt","eta","status","prompt","taudecay","last copy"))
    for i, particle in enumerate(particles):
      ...
      if 0<=mothidx<particles._len:
        ...
        print(" %7d %7d %7d %7d %7.2f %7.2f %7.2f %7.2f %7d %8s %9s %10s"%(
          i,particle.pdgId,mothidx,mothpid,mothdR,particle.mass,particle.pt,eta,particle.status,prompt,taudecay,lastcopy))
      else:
        print(" %7d %7d %7s %7s %7s %7.2f %7.2f %7.2f %7d %8s %9s %10s"%(
          i,particle.pdgId,"","","",particle.mass,particle.pt,eta,particle.status,prompt,taudecay,lastcopy))
      if lastcopy:
