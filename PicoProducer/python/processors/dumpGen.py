...
class LHEDumper(Module):
  ...
  def analyze(self,event):
    ...
    print " \033[4m%7s %8s %8s %8s %8s %8s %8s %9s %10s  \033[0m"%(
      "index","pdgId","moth","mothid","dR","pt","status","prompt","last copy")
    for i, particle in enumerate(particles):
      ...
      print " %7d %8d %8d %8d %8.2f %8.2f %8d %9s %10s"%(
        i,particle.pdgId,mothidx,mothpid,mothdR,particle.pt,particle.status,prompt,lastcopy)
