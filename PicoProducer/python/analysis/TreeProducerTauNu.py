# Authors : Jacopo Malvaso, Alexei Raspereza (August 2022)
# Description : tree class for selected W*->tauv candidates
...
class TreeProducerTauNu(TreeProducerHighPT):
  ...
  def __init__(self, filename, module, **kwargs):
    ...
    self.addBranch('rawDeepTau2018v2p5VSe_1',    'f')
    self.addBranch('rawDeepTau2018v2p5VSmu_1',   'f')
    self.addBranch('rawDeepTau2018v2p5VSjet_1',  'f')
    self.addBranch('idDeepTau2018v2p5VSe_1',     'i')
    self.addBranch('idDeepTau2018v2p5VSmu_1',    'i')
    self.addBranch('idDeepTau2018v2p5VSjet_1',   'i')
    self.addBranch('jpt_match_1',                'f', -1, title="pt of jet matching tau")
    self.addBranch('jeta_match_1',               'f', -1, title="eta of jet matching tau")
    ...
    if self.module.ismc:
      ...
      self.addBranch('jeta_genmatch_1',          'f', -1, title="eta of gen jet matching tau")
