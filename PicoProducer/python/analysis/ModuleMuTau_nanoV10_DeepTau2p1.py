...
class ModuleMuTau_DeepTau2p5_2p1Sel(ModuleTauPair):
  
  def __init__(self, fname, **kwargs):
    kwargs['channel'] = 'mutau'
    super(ModuleMuTau_DeepTau2p5_2p1Sel,self).__init__(fname,**kwargs)
  ...
  def beginJob(self):
    ...
    super(ModuleMuTau_DeepTau2p5_2p1Sel,self).beginJob()
