...
class ModuleTauPair_trig(Module):
  ...
  def __init__(self, fname, **kwargs):
    ...
    if any(y in self.era for y in ['2022','2023','2024','2025']): # only mandatory for Run 3: 2022, 2023, ... (see https://cms-jerc.web.cern.ch/Recommendations/#jet-veto-maps)
