...
samples  = [
    ...
    M('ST','TbarWplustoLNu2Q',
      "/TbarWplustoLNu2Q_TuneCP5_ERDOn_13p6TeV_powheg-pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v15-v3/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts),
    ...
    # W->taunu
    M('WtoNuTau','WtoNuTau',
      "/WtoNuTau_M-200_TuneCP5_13p6TeV_pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14-v2/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts_wstar),

    # W->munu
    M('WtoMuNu','WtoMuNu',
      "/WtoMuNu_M-200_TuneCP5_13p6TeV_pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14-v2/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts_wstar),
    
    # Z->vv HT binned
    M('Zto2Nu_HT','Zto2Nu-4Jets_HT-200to400',
      "/Zto2Nu-4Jets_HT-200to400_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14-v2/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts),
    M('Zto2Nu_HT','Zto2Nu-4Jets_HT-400to800',
      "/Zto2Nu-4Jets_HT-400to800_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14-v2/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts),
    M('Zto2Nu_HT','Zto2Nu-4Jets_HT-800to1500',
      "/Zto2Nu-4Jets_HT-800to1500_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14-v2/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts),

    # W->lnu HT binned
    M('WtoLNu_HT','WtoLNu_HT100to400',
      "/WtoLNu-4Jets_MLNu-0to120_HT-100to400_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14-v2/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts),
    M('WtoLNu_HT','WtoLNu_HT400to800',
      "/WtoLNu-4Jets_MLNu-0to120_HT-400to800_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14-v2/NANOAODSIM",
      store=storage,url=url,files=filelist,opts=opts),

    # JetMET
    D('JetMET','JetMET0_v1',"/JetMET0/Run2023C-22Sep2023_v1-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    D('JetMET','JetMET0_v2',"/JetMET0/Run2023C-22Sep2023_v2-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    D('JetMET','JetMET0_v3',"/JetMET0/Run2023C-22Sep2023_v3-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    D('JetMET','JetMET0_v4',"/JetMET0/Run2023C-22Sep2023_v4-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    D('JetMET','JetMET1_v1',"/JetMET1/Run2023C-22Sep2023_v1-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    D('JetMET','JetMET1_v2',"/JetMET1/Run2023C-22Sep2023_v2-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    D('JetMET','JetMET1_v3',"/JetMET1/Run2023C-22Sep2023_v3-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    D('JetMET','JetMET1_v4',"/JetMET1/Run2023C-22Sep2023_v4-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['taunu','dijets']),
    
    # SINGLE MUON
    D('Muon','Muon0_v1',"/Muon0/Run2023C-22Sep2023_v1-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
    D('Muon','Muon0_v2',"/Muon0/Run2023C-22Sep2023_v2-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
    D('Muon','Muon0_v3',"/Muon0/Run2023C-22Sep2023_v3-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
    D('Muon','Muon0_v4',"/Muon0/Run2023C-22Sep2023_v4-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
    D('Muon','Muon1_v1',"/Muon1/Run2023C-22Sep2023_v1-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
    D('Muon','Muon1_v2',"/Muon1/Run2023C-22Sep2023_v2-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
    D('Muon','Muon1_v3',"/Muon1/Run2023C-22Sep2023_v3-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
    D('Muon','Muon1_v4',"/Muon1/Run2023C-22Sep2023_v4-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts=opts,channels=['munu','wjets']),
