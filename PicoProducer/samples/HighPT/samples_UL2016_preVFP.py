...
storage  = "/eos/cms/store/group/phys_tau/TauFW/nanoV10/Run2_2016_HIPM/$SAMPLE"
...
samples  = [
    ...
    # SINGLE MUON
    D('SingleMu_Run2016B','SingleMuon_Run2016B',"/SingleMuon/Run2017B-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'mutau','mumu','emu','highpt', "munu", "wjets"]),
    D('SingleMu_Run2016C','SingleMuon_Run2016C',"/SingleMuon/Run2017C-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'mutau','mumu','emu','highpt', 'munu', 'wjets']),
    D('SingleMu_Run2016D','SingleMuon_Run2016D',"/SingleMuon/Run2017D-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'mutau','mumu','emu','highpt', 'munu', 'wjets']),
    D('SingleMu_Run2016E','SingleMuon_Run2016E',"/SingleMuon/Run2017E-UL2017_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'mutau','mumu','emu','highpt', 'munu', 'wjets']),
    ...
    # MET
    D('MET_Run2016B','MET_Run2016B',"/MET/Run2016B-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'taunu']),
    D('MET_Run2016C','MET_Run2016C',"/MET/Run2016C-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'taunu']),
    D('MET_Run2016D','MET_Run2016D',"/MET/Run2016D-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'taunu']),
    D('MET_Run2016E','MET_Run2016E',"/MET/Run2016E-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'taunu']),
    ...
    # JET
    D('JetHT_Run2016B','JetHT_Run2016B',"/JetHT/Run2016B-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'dijets']),
    D('JetHT_Run2016C','JetHT_Run2016C',"/JetHT/Run2016C-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'dijets']),
    D('JetHT_Run2016D','JetHT_Run2016D',"/JetHT/Run2016D-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'dijets']),
    D('JetHT_Run2016E','JetHT_Run2016E',"/JetHT/Run2016E-UL2016_MiniAODv2_NanoAODv9-v1/NANOAOD",
      store=storage,url=url,files=filelist,opts="useT1=False",channels=["skim*",'highpt', 'dijets']),
